...
const SEED: { areaName: string; siteId: string; category: string; isActive: boolean }[] = [
  ...
  { areaName: "JETTY 1", siteId: "site-buleleng", category: "Dumping", isActive: true },
  { areaName: "JETTY 2", siteId: "site-kabaena", category: "Dumping", isActive: true },
  { areaName: "JETTY 3", siteId: "site-kabaena", category: "Dumping", isActive: false },
  { areaName: "JETTY 4", siteId: "site-kabaena", category: "Dumping", isActive: true },
  { areaName: "JETTY 5", siteId: "site-kabaena", category: "Dumping", isActive: true },
