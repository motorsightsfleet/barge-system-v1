  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-6" onClick={() => setOpenMenuId(null)}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Variant Specification</h1>
          <p className="text-sm text-gray-500 mt-1">Manage variant specification data in a centralized system</p>
        </div>
